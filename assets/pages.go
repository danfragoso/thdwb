...
func HomePage() []byte {
    ...
    <body>
       ...
       <p>
            If you try to access a website it may not really load correctly, the reason is because the layout implementation is pretty lacking at the moment, I got a basic implemetation of a display block and list item. For now there's no flexbox, no inline and no inline-block.
       </p>
        <p>
